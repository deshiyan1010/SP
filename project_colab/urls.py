"""project_colab URL Configuration
...
urlpatterns = [
    ...
    path('',include('networking.urls'),name="networking"),
    path('',include('posts.urls'),name="posts"),
    path('',include('profilepage.urls'),name="profilepage"),
    path('',include('project_management.urls'),name="project_management"),
    path('admin/', admin.site.urls),
    path('logout/',views.user_logout,name='logout'),
    path('special/',views.special,name='special'),
    path('friendship/', include('friendship.urls'),name='friendship'),
